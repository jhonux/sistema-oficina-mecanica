...
def gerar_os(request, identificador):
    ...
    pdf.cell(35, 10, 'Carro:', 1, 0, 'L', 1)
    if servico.carro:
        pdf.cell(0, 10, f'{servico.carro}', 1, 1, 'L', 1)
    else:
        pdf.cell(0, 10, 'N/A', 1, 1, 'L', 1)  # Ou qualquer valor que você deseje exibir quando o carro é nulo


    pdf.cell(35, 10, 'Serviços:', 1, 0, 'L', 1)
